...
class AddfaqSecion extends React.Component {
...
//    }
   findAllFAQ() {
      ...
      fetch("/faqSection/get", requestOptions)
         .then(handleResponse)
         .then(data => {
            if (typeof data !== 'undefined') {
               let faqData = data.faq
               console.log(faqData,"faqSection")
...
//          headers: authHeader(),
//       };
//       fetch("/faqSection/get/" + id, requestOptions)
//          .then(handleResponse)
//          .then(data => {
               ...
               <div className="container-fluid">
                  <div className="row bg-title">
                     <div className="col-lg-3 col-md-4 col-sm-4 col-xs-6 col-6">
                        <h4 className="page-title">FAQ Section</h4>
                     </div>
                     <div className="col-lg-9 col-sm-8 col-md-8 col-xs-6 col-6">
                        <ol className="breadcrumb">
                           ...
                           <li className="active">FAQ Section</li>
                        </ol>
                     </div>
                  </div>
                  <div className="section-tab">
                     <div className="nav flex-column nav-pills" id="v-pills-tab"
                        ...
                        <button className="btn bg-white text-left w-100" >
                           + Add another faq Section
                        </button>
                     </div>
